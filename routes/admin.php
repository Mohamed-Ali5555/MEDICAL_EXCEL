    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::group(['prefix' => 'language', 'as' => 'language.','middleware'=>['module:system_settings']], function () {
                ...
                Route::get('/get/translate/{lang}' ,'LanguageController@get_language')->name('get-language');
            });
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order_management']], function () {
            ...
            Route::get('collect/order/{status}', 'OrderController@collect_order')->name('collect_order');

            /////////////////
            Route::get('collect_details/{collect_id}', 'OrderController@collect_details')->name('collect_details');
            ///////////////
        ...
        Route::group(['prefix' => 'helpTopic', 'as' => 'helpTopic.','middleware'=>['module:system_settings']], function () {
            ...
            Route::get('s/{id}', 'HelpTopicController@edit');
