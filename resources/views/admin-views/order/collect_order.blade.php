...
@section('content')
                                ...
                                <tr class="status-{{$order['order_status']}} class-all">
                                    ...
                                    <td class="text-right">
                                        <div>
                                            ...
                                            @endif
                                            {{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($order->total_amount+$discount))}}
                                        </div>
    ...
    href="{{ route('admin.orders.collect_details', ['collect_id' => $order->collect_id]) }}">
    <img src="{{ asset('/public/assets/back-end/img/eye.svg') }}" class="svg" alt="">
</a>


{{-- <a class="btn btn-outline--primary square-btn btn-sm mr-1" title="{{ \App\CPU\translate('view') }}"
    href="{{ route('admins.orders.details', ['createdAt' => $order->created_at]) }}">
    <img src="{{ asset('/public/assets/back-end/img/eye.svg') }}" class="svg" alt="">
</a> --}}
