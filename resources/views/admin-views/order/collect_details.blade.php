    ...
    <div class="content container-fluid">
        ...
        <div class="row gy-3" id="printableArea">
            <div class="col-lg-8 col-xl-9">
                <!-- Card -->
                <div class="card h-100" id="print">
                    <!-- Body -->
                    <div class="card-body"  >
                        <div class="d-flex flex-wrap gap-10 justify-content-between mb-4">

                              <div class="d-flex flex-column gap-10">
                                <h4 class="text-capitalize">{{\App\CPU\translate('collect_id')}} #{{$order['collect_id']}}</h4>
                                <div class="">
                            ...
                            <div class="text-sm-right">
                                <div class="d-flex flex-wrap gap-10">
                                    ...
                                    <a class="btn btn--primary px-4 print-button" 
                                      onclick="printDiv()" id="print_div">
                                        <i class="tio-print mr-1"></i> {{\App\CPU\translate('Print')}} {{\App\CPU\translate('invoice')}}
                                    </a>

                        {{-- <button  class="btn btn-danger float-left mt-3 mr-2 print-button" onclick="printDiv()" id="print_div">
...
@php($sub_total_all = 0)
{{-- this part is show seller name and under this orders --}}
 @foreach ($collect_order_detail as $group_key => $group)
             ...
             @endforeach
                        ...
                        {{-- @foreach ($collect_order_detail as $order) --}}
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row gy-1 text-sm-right">
                                    ...
                                    <dd class="col-6 title-color">
                                        <strong  class="total">{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($total  - $coupon_discount)) }}</strong>
                                    </dd>
                                </dl>
                                <!-- End Row -->
                            </div>
  ...
  @endforeach
                    ...
                    <!-- End Body -->
                       @php($shipping = $order['shipping_cost'])
                        ...
                        <div class="row justify-content-md-end mb-3" >
                        <h1 class="col-md-12 text-center">Collecting</h1>
                            <div class="col-md-9 col-lg-8">
                                <dl class="row gy-1 text-sm-right">
                                    <dt class="col-5">{{ \App\CPU\translate('Shipping') }}</dt>
                                    <dd class="col-6 title-color">
                                        <strong id="shipping">{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($shipping)) }}</strong>
                                    </dd>
                                    ...
                                    <dd class="col-6 title-color">
                                        ...
                                        <strong>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency( $sub_total_all + $shipping - $coupon_discount)) }}</strong>
...
let shippingText = shippingElement.textContent.trim();
let shippingValue = parseFloat(shippingText)||0;
  $('.total').each(function() {
    let total = parseFloat($(this).text().trim()) || 0;
    sum += total;
  });
alert(shippingValue  + sum );
    $('#sub_total').text(shippingValue  + sum);
