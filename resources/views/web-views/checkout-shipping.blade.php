        ...
        <div class="row">
            <div class="col-md-12 mb-5 pt-5">
                <div class="feature_header">
                    <span>{{ \App\CPU\translate('shipping') }}
                        {{ $billing_input_by_customer == 1 ? \App\CPU\translate('and') . ' ' . \App\CPU\translate('billing') : ' ' }}
            ...
            <section class="col-lg-8">
                <div class="checkout_details">
                    ...
                    @if ($physical_product_view)
                        ...
                        @php(
    $shipping_addresses = \App\Model\ShippingAddress::where('customer_id', auth('customer')->id())->where('is_billing', 0)->get()
)
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item" onclick="anotherAddress()">
                                        <input type="radio" name="shipping_method_id" id="sh-0" value="0"
                                            ...
                                            {{ $shipping_addresses->count() == 0 ? 'checked' : '' }}>
                                        <span class="checkmark"
                                            style="margin-{{ Session::get('direction') === 'rtl' ? 'left' : 'right' }}: 10px"></span>

                                        <button type="button" class="btn btn-outline" data-toggle="collapse"
                                            data-target="#collapseThree">{{ \App\CPU\translate('Another') }}
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="address_type">
                                                            ...
                                                            <option value="home">{{ \App\CPU\translate('Home') }}
                                                            </option>
                                                    ...
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputEmail1">{{ \App\CPU\translate('City') }}<span
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if ($zip_restrict_status == 1)
                                                            <select name="zip" class="form-control selectpicker"
                                                                ...
                                                                @empty
                                                                    <option value="">
                                                                        {{ \App\CPU\translate('No_zip_to_deliver') }}
                                                                    </option>
                                                                @endforelse
                                                            </select>
                                                        @else
                    ...
                    <div style="display: {{ $billing_input_by_customer ? '' : 'none' }}">
                        ...
                        @php(
    $billing_addresses = \App\Model\ShippingAddress::where('customer_id', auth('customer')->id())->where('is_billing', 1)->get()
)
                        @if ($physical_product_view)
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="billing_address_type">
                                                            <option value="permanent">
                                                                {{ \App\CPU\translate('Permanent') }}</option>
                                                            <option value="home">{{ \App\CPU\translate('Home') }}
                                                            </option>
                                                            <option value="others">{{ \App\CPU\translate('Others') }}
                                                            </option>
                                                    ...
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputEmail1">{{ \App\CPU\translate('address') }}<span
                                                                class="text-danger">*</span></label>
                                                        <textarea class="form-control" id="billing_address" type="billing_text" name="billing_address"
            ...
            if (physical_product === 'yes') {
                ...
                document.getElementById("address-form").querySelectorAll("[required]").forEach(function(i) {
                    ...
                    if (i.type === "radio") {
                        ...
                        document.getElementById("address-form").querySelectorAll(`[name=${i.name}]`).forEach(
                            function(r) {
                ...
                if (billing_addresss_same_shipping != true) {
                    ...
                    document.getElementById("billing-address-form").querySelectorAll("[required]").forEach(function(i) {
                        ...
                        if (i.type === "radio") {
                            let radioValueCheck = false;
                            document.getElementById("billing-address-form").querySelectorAll(`[name=${i.name}]`)
                                .forEach(function(r) {
                                    if (r.checked) radioValueCheck = true;
                                });
