                        ...
                        @if (\App\CPU\Helpers::module_permission_check('order_management'))
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                   ...
                                   <li class="nav-item {{ Request::is('admin/orders/collect_order/all') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('admin.orders.collect_order', ['all']) }}"
                                            title="{{ \App\CPU\translate('collect_order') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                                {{ \App\CPU\translate('collect_order') }}
                                                <span class="badge badge-soft-info badge-pill ml-1">
                                                    {{ \App\Model\Order::select('customer_id', 'collect_id')->groupBy('collect_id')->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
